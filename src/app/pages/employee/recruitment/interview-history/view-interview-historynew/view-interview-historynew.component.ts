...
@Component({
  selector: 'app-view-interview-historynew',
  templateUrl: './view-interview-historynew.component.html',
  styleUrls: ['./view-interview-historynew.component.css']
})
export class ViewInterviewHistorynewComponent implements OnInit {
