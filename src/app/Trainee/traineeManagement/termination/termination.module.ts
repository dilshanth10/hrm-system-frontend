...
@NgModule({
  ...
  declarations: [TerminationComponent, ViewTerminationHistoryComponent, AddTerminationHistoryComponent, EditTerminationHistoryComponent, DeleteTerminationHistoryComponent]
})
